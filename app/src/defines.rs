...
pub mod icons {
    ...
    pub const FOLDER_OPEN: &[u8] = include_bytes!("../../resources/folder-open.svg");
    pub const SORT_ON: &[u8] = include_bytes!("../../resources/sort-on.svg");
    pub const SORT_OFF: &[u8] = include_bytes!("../../resources/sort-off.svg");
}
